...
try:
    ...
    in_text = open('/home/shin/DeepLearning/Lasagne/Recipes-master/examples/input_test.txt').read()
...
def main(num_epochs=NUM_EPOCHS):
    ...
    #这里用一个slice只取了第二维的最后一个，也就是lstm最后一个时刻的编码向量
    ...
    tmp_output=lasagne.layers.get_output(l_forward_1)
    ...
    train = theano.function([l_in.input_var, target_values], [cost,tmp_output], updates=updates, allow_input_downcast=True)
